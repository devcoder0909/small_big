...
from sqlalchemy import BigInteger, Integer, Float, Text, DateTime, JSON
...
class AnalyticsSnapshot(Base):
    ...
    transition_statistics: Mapped[dict | None] = mapped_column(JSON_TYPE, nullable=True)
    anomaly_statistics: Mapped[dict | None] = mapped_column(JSON_TYPE, nullable=True)
    prediction_data: Mapped[dict | None] = mapped_column(JSON_TYPE, nullable=True)
